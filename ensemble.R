...
breeds <- breed_table$Var1[1:15]
colors <- color_table$Var1[1:15]
...
factorize = c('sex_upon_intake','age_upon_intake_age_group','intake_year','sex_upon_outcome','outcome_month','outcome_year','Mix_Or_Not','breed_redcd','color_redcd','intake_time','outcome_time')
...
SVModel <- train(outcome_type ~ .-animal_id_outcome-age_upon_intake_age_group-intake_condition, data = trainingData,
                 method = "svmPoly",
