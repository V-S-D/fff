...
complete$breed=complete$color=NULL
#complete$NewColor
...
factorize = c('sex_upon_intake','age_upon_intake_age_group','intake_year','sex_upon_outcome','outcome_month','outcome_year','Mix_Or_Not','breed_redcd','NewColor','intake_time','outcome_time')
...
train(outcome_type~.-animal_id_outcome-age_upon_intake_age_group-outcome_year-outcome_type-intake_time,data=new_train,method="rpart",trControl=numFOlds,tuneGrid=cpGrid)
ModelCV=rpart(outcome_type~.-animal_id_outcome-age_upon_intake_age_group-outcome_year-outcome_type-intake_time,data=new_train,cp=0.01)
